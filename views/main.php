    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
        <div class="container-fluid">
            <a href="main.php" class="navbar-brand ms-sm-3">
                ...
                <span class="ms-3 fs-5">SisCadPF – Sistema de Cadastro de Pessoa Física</span>
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                            ...
                            <span class="ps-1 text-white">Pessoa Física</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a href="#" onclick="submit_action('pessoas/'); return false;" class="dropdown-item">Cadastrar</a></li>
                        </ul>
                    </li>
