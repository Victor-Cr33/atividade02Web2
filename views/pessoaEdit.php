...
<html lang="pt-br">
    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
            <div class="container-fluid">
                <a href="main.php" class="navbar-brand ms-sm-3">
                    ...
                    <span class="ms-3 fs-5">SisCadPF</span>
                </a>
        ...
        <div class="container py-4">        
            <form class="form" method="post" action="pessoaEdit.php">
                <input type="hidden" name="form_submit" value="OK">

                <h3 class="display-7 text-secondary"><b>Atualizar Dados</b></h3>
                <div class="row">
                    <div class="col" >
                ...
                <div class="row">
                    <div class="col">
                        <a href="pessoaIndex.php" class="btn btn-secondary btn-block align-content-center">
